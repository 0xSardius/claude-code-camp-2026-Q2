...
module Boukensha
  class Context
    ...
    def register_tool(tool)
      ...
      # 02_the_registry (and its 01/03/04/05/06 backports/reapplications) --
      # reapplied here since this file's copy had regressed to the unfixed
      # version (8th occurrence -- see docs/plans/python_port/07_the_run_dsl).
