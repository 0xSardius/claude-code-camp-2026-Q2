...
## Considerations
These are things we observed but we do not want fixed since this will break with future steps
- We have a default prompt eg. prompts/system.md it supposed to be scoped on task eg. prompts/<task>/system.md
