"""Port of week1_baseline/ruby/05_agent_loop/lib/boukensha.rb -- now
aggregates Config, Player (and transitively Base), Tool, Message, Context,
Registry, UnknownToolError, UnsupportedModelError, ApiError, LoopError,
PromptBuilder, Client, Agent, and the five API backends.
"""
