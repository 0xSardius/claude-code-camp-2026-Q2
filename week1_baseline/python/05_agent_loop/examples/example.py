"""Port of week1_baseline/ruby/05_agent_loop/examples/example.rb.
...
non-deterministic). See docs/plans/python_port/05_agent_loop's
acceptance-test section for how parity was actually verified for this step.
"""
import os
