"""Port of week1_baseline/ruby/10_standard_tool_library/lib/boukensha.rb --
adds working_dir:/allowed_commands:/shell_timeout:/mud: to run()/repl(),
auto-registering Tools::FileSystem/Shell/Mud (see
docs/plans/python_port/10_standard_tool_library).
