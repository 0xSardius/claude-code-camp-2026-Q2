"""Port of week1_baseline/ruby/07_the_run_dsl/lib/boukensha/config.rb --
functionally identical to 05_agent_loop's Ruby source (confirmed by direct
diff: only cosmetic endless-method-vs-multi-line-def style differences),
so this file carries forward from 05_agent_loop's Python, not
06_the_logger's (which had temporarily dropped the mud_* methods -- see
docs/plans/python_port/07_the_run_dsl's "toggle" note). Keep this a
