"""Port of week1_baseline/ruby/08_the_repl_loop/lib/boukensha/context.rb --
adds clear_messages (Ruby: clear_messages!), used by the REPL's /clear
command (see docs/plans/python_port/08_the_repl_loop).
