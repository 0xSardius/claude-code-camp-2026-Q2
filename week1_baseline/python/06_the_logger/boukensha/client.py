"""Port of week1_baseline/ruby/05_agent_loop/lib/boukensha/client.rb --
byte-identical to 04_api_client's version except a tools= kwarg on call(),
threaded through to to_api_payload (see docs/plans/python_port/05_agent_loop).
