"""Port of week1_baseline/ruby/03_prompt_builder/lib/boukensha/config.rb --
see docs/plans/python_port/03_prompt_builder for the port plan. Keep this a
literal mirror of the Ruby Config class; re-read the Ruby source before
changing behavior here.

This step's config.rb adds PROMPTS_DIR back (absent since 01_struct_skeleton
-- see docs/plans/python_port/01_struct_skeleton) because examples/example.py
now needs a default_prompts_dir to resolve the system prompt.
"""
