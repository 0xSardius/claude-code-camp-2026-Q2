"""Port of week1_baseline/ruby/01_struct_skeleton/lib/boukensha/tasks/base.rb
(byte-identical to 00_config's version -- see docs/plans/python_port/01_struct_skeleton
for confirmation) -- see docs/plans/python_port/00_config for the original
port plan. Keep this a literal mirror of the Ruby Tasks::Base class; re-read
the Ruby source before changing behavior here.
